...
**Schema-defined CMS for Firebase.** Define your content models in TypeScript — get a full admin panel, typed SDK, Zod validation, and Firestore sync, all generated automatically.
...
| `@blazing-cms/generators`  | Code generation (types, SDK, Zod)                                       |
