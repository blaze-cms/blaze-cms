...
export const settingsWebhookDetailRoute = createRoute({
  getParentRoute: () => appLayoutRoute,
  path: "/settings/webhooks/$id",
  component: SettingsWebhookDetail,
});

function SettingsWebhookDetail() {
  const { id } = settingsWebhookDetailRoute.useParams();
